...
private WPI_TalonSRX rightElbow;
...
leftShoulder = new WPI_TalonFX(6);
 
 

leftElbow = new WPI_TalonSRX(7);
 
 

rightShoulder = new WPI_TalonFX(8);
 
 

rightElbow = new WPI_TalonSRX(9);
    ...
    public void periodic() {
        ...
        SmartDashboard.putBoolean("leftElbowLimitSwitch", isLeftHand());
        SmartDashboard.putBoolean("LeftShoulder", isLeftShoulder());
        SmartDashboard.putNumber("leftShoulderEncoder", rightElbowEncoder.get());
    ...
    public boolean isRightHand() {
        return rightHandLimitSwitch.get();
    }
    public boolean isRightElbow() {
        return rightElbowLimitSwitch.get();
    }
    public boolean isRightShoulder() {
        return rightShoulderLimitSwitch.get();
    }
