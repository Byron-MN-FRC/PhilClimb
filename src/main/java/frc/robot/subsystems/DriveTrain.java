...
linearServo = new Servo(0);
 addChild("linearServo", linearServo);
    ...
    linearServo.setBounds(HOOD_MAX_PWM, CENTER_SERVO_PWM + SERVO_DEADBAND, 
	...
	startAngle = linearServo.getAngle();
	startTime = Timer.getFPGATimestamp();
		
	linearServo.setAngle(degrees);
    }
